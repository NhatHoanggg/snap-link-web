...
import { Eye, EyeOff, Lock, Mail, User, LinkIcon, MapPin } from "lucide-react";
    ...
    try {
      if (formData.role === "CUSTOMER") {
        ...
        toast({
          title: "Registration Successful",
          description:
            "Your photographer account has been created successfully",
        });
        router.push("/login");
      }
    } catch (error) {
                ...
                <div className="flex items-center justify-between space-x-2">
                  <Label htmlFor="role" className="text-sm font-medium">
                    ...
                    {formData.role === "CUSTOMER" ? (
                      ...
                      <p className="text-sm font-medium line-through italic">
                        Customer
                      </p>
                    )}
                  </Label>
                    ...
                    {formData.password && (
                      <div className="mt-2 space-y-1">
                        ...
                        <Progress
                          ...
                          className={cn("h-1.5", getPasswordStrengthColor())}
                        />
                      </div>
                    )}
                  </div>
