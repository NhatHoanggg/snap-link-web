...
import { createDiscountPhotographer, type DiscountCreate } from "@/services/discount.service"
...
export default function CreateDiscountPage() {
  ...
  const handleCreateDiscount = async () => {
    ...
    setIsLoading(true)
    try {
      await createDiscountPhotographer(formData)
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Điền thông tin để tạo mã giảm giá mới cho dịch vụ của bạn</p>
          </div>
        ...
        <div className="bg-card border rounded-lg p-6 space-y-6">
          ...
          <div className="flex justify-end space-x-4 pt-4">
            <Button variant="outline" onClick={() => router.push("/manage/discounts")} disabled={isLoading}>
              Hủy
            </Button>
